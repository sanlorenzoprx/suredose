...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ByYbzEuu.mjs");
...
var manifest = {
	"2a722a22c88f1a0e65cefd13d14e3055eaad3e46b4b81a17a7a39c6197f8d443": {
		functionName: "readBottleLabel_createServerFn_handler",
		importer: () => import("./ai-AeGXGtCM.mjs")
	},
	"63a79891fcb37df693e3223573ca07147bc34e6bd6437df2d821e16f55c76352": {
		functionName: "comparePills_createServerFn_handler",
		importer: () => import("./ai-AeGXGtCM.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-3OQvg7-J.mjs").then((n) => n.t),
